...
def train(model: nn.Module,
    ...
    #print ("length of train_loader:", (train_loader))
    # Train_loader:
    ...
    for i, (train_batch, idx, labels_batch) in enumerate(tqdm(train_loader)):
        ...
        #print ("Train window:", params.train_window) ## 130 train data
        #print ("Train batch:", len(train_batch)) ## window size 24
